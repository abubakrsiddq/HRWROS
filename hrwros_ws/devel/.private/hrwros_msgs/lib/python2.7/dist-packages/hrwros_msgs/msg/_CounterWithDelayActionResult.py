...
"""autogenerated by genpy from hrwros_msgs/CounterWithDelayActionResult.msg. Do not edit."""
import sys
...
class CounterWithDelayActionResult(genpy.Message):
  _md5sum = "a1a320d1df2c9d395935accf585f1532"
  _type = "hrwros_msgs/CounterWithDelayActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hrwros_msgs/CounterWithDelayResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CounterWithDelayActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hrwros_msgs.msg.CounterWithDelayResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hrwros_msgs.msg.CounterWithDelayResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.result_message = str[start:end].decode('utf-8')
      else:
        self.result.result_message = str[start:end]
      return self
