...
"""autogenerated by genpy from hrwros_msgs/CounterWithDelayAction.msg. Do not edit."""
import sys
...
import genpy
import hrwros_msgs.msg
import actionlib_msgs.msg
import std_msgs.msg

class CounterWithDelayAction(genpy.Message):
  _md5sum = "3510064e2e8600da6f7a564f41861085"
  _type = "hrwros_msgs/CounterWithDelayAction"
...
"""
  ...
  _slot_types = ['hrwros_msgs/CounterWithDelayActionGoal','hrwros_msgs/CounterWithDelayActionResult','hrwros_msgs/CounterWithDelayActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CounterWithDelayAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = hrwros_msgs.msg.CounterWithDelayActionGoal()
      if self.action_result is None:
        self.action_result = hrwros_msgs.msg.CounterWithDelayActionResult()
      if self.action_feedback is None:
        self.action_feedback = hrwros_msgs.msg.CounterWithDelayActionFeedback()
    else:
      self.action_goal = hrwros_msgs.msg.CounterWithDelayActionGoal()
      self.action_result = hrwros_msgs.msg.CounterWithDelayActionResult()
      self.action_feedback = hrwros_msgs.msg.CounterWithDelayActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_4I().pack(_x.action_goal.goal.num_counts, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_result.result.result_message
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_I().pack(self.action_feedback.feedback.counts_elapsed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.num_counts, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_4I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.result_message = str[start:end].decode('utf-8')
      else:
        self.action_result.result.result_message = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (self.action_feedback.feedback.counts_elapsed,) = _get_struct_I().unpack(str[start:end])
      return self
