...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.pick_approach.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.pick_pose.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.pick_retreat.header.frame_id = str[start:end].decode('utf-8')
      else:
