...
"""autogenerated by genpy from hrwros_msgs/CounterWithDelayActionFeedback.msg. Do not edit."""
import sys
...
class CounterWithDelayActionFeedback(genpy.Message):
  _md5sum = "e8c31ee64181a8a6c44c39afa813d19c"
  _type = "hrwros_msgs/CounterWithDelayActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hrwros_msgs/CounterWithDelayFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CounterWithDelayActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = hrwros_msgs.msg.CounterWithDelayFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hrwros_msgs.msg.CounterWithDelayFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_I().pack(self.feedback.counts_elapsed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.counts_elapsed,) = _get_struct_I().unpack(str[start:end])
      return self
