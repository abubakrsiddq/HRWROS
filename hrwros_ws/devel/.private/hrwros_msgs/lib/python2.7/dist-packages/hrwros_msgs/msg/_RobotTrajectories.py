...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.cur_to_approach.joint_trajectory.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.cur_to_approach.multi_dof_joint_trajectory.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.approach_to_pick.joint_trajectory.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.approach_to_pick.multi_dof_joint_trajectory.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.pick_to_retreat.joint_trajectory.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.pick_to_retreat.multi_dof_joint_trajectory.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.retreat_to_place.joint_trajectory.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.retreat_to_place.multi_dof_joint_trajectory.header.frame_id = str[start:end].decode('utf-8')
      else:
